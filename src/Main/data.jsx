...
export const dataExperience = {
  ...
  info: {
    0: {
      ...
      first: "Developed React applications using Redux Toolkit state management and RESTful APIs. Developed RESTful APIs using ASP.NET Core and Django Rest Framework for complex data-driven applications. Developed and maintained web applications using Django, HTML5, CSS3, JavaScript, jQuery and MySQL.",
    },
    1: {
